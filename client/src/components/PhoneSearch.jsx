...
const PhoneSearch = ({ searchHandler }) => (
  <nav id="nav" className="navbar navbar-expand-lg navbar-light bg-light">
    <div className="container-fluid">
      ...
      <div id="right">
        <button id="hostLink" className="btn btn-light" type="submit">Become a host</button>
        <button id="region" className="btn btn-light" type="submit">
        ...
        <button id="loginLink" className="btn btn-light" type="submit">
